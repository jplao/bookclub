...
review_10 = amazonia.reviews.create(title: 'Five Stars',
...
review_11 = amazonia.reviews.create(title: 'Interesting story',
...
review_12 = amazonia.reviews.create(title: "Parts Were Interesting But it is Too Unrealistic For My Taste",
...
review_16 = late_show.reviews.create(title: "I don't get the great reviews. And comparing her to Bosch",
...
review_17 = late_show.reviews.create(title: "Hard to believe it's written by Michael Connelly",
...
review_18 = two_kinds.reviews.create(title: 'Another fabulous Harry Bosch book',
...
review_19 = two_kinds.reviews.create(title: 'Have read and enjoyed all the previous 19 books',
...
review_20 = two_kinds.reviews.create(title: 'Harry Bosch at his best!',
...
review_21 = two_kinds.reviews.create(title: 'Another great entry in a great series.',
...
review_22 = two_kinds.reviews.create(title: 'Harry Bosch returns for another entertaining tale',
...
review_24 = black_ice.reviews.create(title: 'Bosch heads south across the border',
...
review_25 = black_ice.reviews.create(title: 'Storytelling of the highest order.',
...
review_26 = black_ice.reviews.create(title: 'Entertaining and Engaging',
...
review_27 = black_ice.reviews.create(title: 'Druglords, Crime, and International Lawlessness Corrupts',
...
review_28 = black_ice.reviews.create(title: 'A protagonist with unwavering dedication to doing the right thing',
...
review_42 = what_ive_done.reviews.create(title: 'Well Delineated',
                        description: "Captivating from the beginning to end." ,
                        score: 5)
review_43 = what_ive_done.reviews.create(title: 'Provoking',
                        description: "Pick it up and you won't put it down." ,
                        score: 4)
review_44 = what_ive_done.reviews.create(title: 'Emotionally Charged',
                        description: "Not for the faint of heart, read with caution." ,
                        score: 2)
review_45 = what_ive_done.reviews.create(title: 'Lackluster',
                        description: "Money can be spent on a better book." ,
                        score: 1)
review_46 = what_ive_done.reviews.create(title: 'Must Read',
                        description: "Enjoyable enough to the point of obsession." ,
                        score: 5)
review_47 = what_ive_done.reviews.create(title: 'Roller-Coaster-Fun',
                        description: "Makes the brain wild while taming the heart.." ,
                        score: 5)
review_48 = what_ive_done.reviews.create(title: 'Final Thoughts',
...
user_4 = User.create(name: "Omari Ron")
